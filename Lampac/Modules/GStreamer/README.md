...
| `segment_buffer` | `7` | Сколько сегментов заранее подготовить и хранить впереди текущей позиции. Минимум `2`. Большое значение увеличивает расход диска и объём фоновой работы. |
